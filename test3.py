...
loguot = browser.find_element(by=By.ID, value='pt-logout')
loguot.click()

sleep(3)

try:
    assert 'Завершение сеанса — Википедия' in browser.title
    print("Выход прошел успешно")
except:
    print("Выход не прошел")
